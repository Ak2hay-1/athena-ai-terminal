  ...
  return (
    <div ref={rootRef} className={cn("relative", className)}>
      <button
        ...
        onClick={() => setOpen((o) => !o)}
        className={cn(
          "flex h-7 min-w-[96px] items-center justify-between gap-1 rounded-sm border border-border bg-panel px-1.5 font-mono text-[11px] text-foreground focus:border-primary/50 focus:outline-none",
          buttonClassName,
        )}
      >
        <span>{value}</span>
